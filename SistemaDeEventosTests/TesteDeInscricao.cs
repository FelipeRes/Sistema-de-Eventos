...
namespace SistemaDeEventosTests {
    ...
    public class TesteDeInscricao {
        ...
        public void adicionar_atividade_repetida_na_inscricao() {
            inscricao = new Inscricao(evento, new Pessoa());
            Atividade palestra = new Atividade(evento, "Lugar");
            inscricao.AdicionarAtividade(new Atividade(evento, "Lugar"));
            try {
                inscricao.AdicionarAtividade(new Atividade(evento, "Lugar"));
                Assert.Fail();
            }catch(Exception e) {
        ...
        public void remover_atividade_que_nao_existe_da_inscricao() {
            ...
            Atividade palestra = new Atividade(evento, "Lugar");
            try {
                inscricao.RemoverAtividade(new Atividade(evento, "Lugar"));
                Assert.Fail();
            } catch (Exception e) {
                Assert.IsTrue(true);
            }
